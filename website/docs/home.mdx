...
<div className="gxp-link-grid">
  <Link className="gxp-link-card" to="/getting-started/first-export/">
    <strong>Run a first export</strong>
    <span>Install the plugin, scan a namespace, review classifications, and download manifests.</span>
  </Link>
  <Link className="gxp-link-card" to="/concepts/classification/">
    <strong>Understand classifications</strong>
    <span>See why resources land in include, cleanup, review, or exclude.</span>
  </Link>
  <Link className="gxp-link-card" to="/reference/rbac/">
    <strong>Check RBAC</strong>
    <span>Map installer, runtime, and end-user permissions to exact OpenShift resources.</span>
  </Link>
</div>
